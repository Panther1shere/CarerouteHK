    ...
    <div className="min-h-screen">
      ...
      <article className="mx-auto max-w-3xl px-6 pb-24 pt-20">
        ...
        <p className="mt-6 text-lg text-muted-foreground">
          Most smart-city tools tell you what is happening. PolicyGraph HK shows you <em>why</em> it
          is happening, who is influencing it, what loops are reinforcing it, where a policy might
          fail, and what combination of actions works better.
        </p>

        <Section title="The problem">
          Governments make decisions in complex systems where the full picture is hard to see. In
          housing, a single decision ripples through tenants, landlords, developers, land prices,
          public housing demand, government budget, transport pressure, inequality, and public
          satisfaction. The challenge is not missing data — it is <em>disconnected</em> data. A
          normal dashboard shows that rent is increasing, but not which feedback loop is driving it.
        </Section>

        <Section title="The frame">
          PolicyGraph HK uses the Innolabs system-thinking framework — system maps, reinforcing and
          balancing feedback loops, and intervention points — to turn public data into structured
        ...
        <Section title="Why now">
          Cities are becoming more complex. Housing, transport, climate, aging population, and
          inequality no longer stand alone — they influence each other. Hong Kong has strong public
          data infrastructure, but the policy layer still needs better tools to turn that data into
